...
A mobile app to fetch data from recipes online and convert them to a shopping list. WIP.
...
1. Clone the repo
   ...
   ```
2. Open it in a Android Studio or a code editor of choice
...
<br />
Project Link: [https://github.com/HawkieOne/Meal-Planner](https://github.com/HawkieOne/Meal-Planner)
